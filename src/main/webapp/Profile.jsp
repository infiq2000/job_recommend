        ...
        <div class="col-lg-8">
            <div class="ps-lg-1-6 ps-xl-5">
                <div class="mb-5 wow fadeIn">
                    ...
                    <p> Chào mọi người nhé</p>
                    <p class="mb-0">Skills and Experience</p>
                </div>
                <div class="mb-5 wow fadeIn">
                    <div class="text-start mb-1-6 wow fadeIn">
                        <h2 class="mb-0 text-primary">Skills and Experience</h2>
                    </div>
                    <div class="row mt-n4">
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    ...
                                    <h3 class="h5 mb-3">Old Job</h3>
                                
                                    <p class="mb-0">${PROFILE.getDevType()}</p>
                                </div>
                            </div>
                        </div>
                       <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    ...
                                    <h3 class="h5 mb-3">Language</h3>
                                    <p class="mb-0">${PROFILE.getLanguageWorkedWith()}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">${PROFILE.getDatabaseWorkedWith()}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    <i class="ti-medall-alt icon-box medium rounded-3 mb-4"></i>
                                    <h3 class="h5 mb-3">Platform Work</h3>
                                    <p class="mb-0">${PROFILE.getPlatformWorkedWith()}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    <i class="ti-medall-alt icon-box medium rounded-3 mb-4"></i>
                                    <h3 class="h5 mb-3">WebFrame</h3>
                                    <p class="mb-0">${PROFILE.getWebFrameWorkedWith()}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    <i class="ti-medall-alt icon-box medium rounded-3 mb-4"></i>
                                    <h3 class="h5 mb-3">OpSys</h3>
                                    <p class="mb-0">${PROFILE.getOpSys()}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 mt-4">
                            <div class="card text-center border-0 rounded-3">
                                <div class="card-body">
                                    <i class="ti-medall-alt icon-box medium rounded-3 mb-4"></i>
                                    <h3 class="h5 mb-3">Dev Enviroment</h3>
                                    <p class="mb-0">${PROFILE.getDevEnviron()}</p>
                                </div>
                            </div>
                        </div>
                    </div>
